...
class User_Model extends CI_Model 
{
    ...
    {
		return $this->db->query("SELECT u.*,p.`name` as province_name, c.`name` as city_name, s.`name` as subdistrict_name FROM users u LEFT JOIN provinces p ON p.id=u.province 
