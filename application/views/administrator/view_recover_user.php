    ...
    <div class="card-body login-card-body">
      ...
      <form action="#" method="post" id='form_login'>
        ...
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="email" readonly value="<?= $user->email; ?>" placeholder="Email">
      ...
      <?php } else {
        echo "Sorry, your data is not valid";
      } ?>
...
$('#form_login').submit(function(e) {
          ...
          type:'POST',
          data:form.serialize(),
          url:"<?= base_url('api/member/forgot_user'); ?>",
          success:function(data) {
            var message = data.message;
            if(data.status == 1) {
              location.reload();
              $(".alert-login").html('<div class="alert alert-success alert-dismissible fade show text-center margin-bottom-1x"><span class="alert-close" data-dismiss="alert"></span><i class="icon-alert-triangle"></i>&nbsp;&nbsp;<span class="text-medium">'+message+'</div>');
            } else {
